...
function xuat_soChan(){ //lặp bằng for
    var ketQua = ""
    for(var i=0; i < 100; i++){
        if(i % 2 == 0){
            ketQua +=  i + ", ";
...
document.getElementById("btnCalc1_soChan").onclick = xuat_soChan; 

function xuat_soLe(){ //lặp bằng while
    var ketQua = "";
    var i = 1;
    while (i < 100){
        if(i % 2 != 0){
...
document.getElementById("btnCalc1_soLe").onclick = xuat_soLe; 

    /**Bài 2 - Đếm số chia hết cho 3 */

function Demso_dungFor(){
    var demso = 0;
    ...
    document.getElementById("result2").innerHTML = "(Dùng For) Số lượng các số chia hết cho 3 dưới 1000 là: " + demso
}
document.getElementById("btnCalc2_for").onclick = Demso_dungFor;

function Demso_dungWhile(){
    var demso = 0;
    var i=1;
    while (i < 1000){
        if(i % 3 == 0){
...
document.getElementById("btnCalc2_while").onclick = Demso_dungWhile;
